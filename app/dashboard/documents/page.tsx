...
export default async function DocumentsPage() {
  ...
  const { data: records } = await supabase
    ...
    .select("id, status, customer_name, customer_phone, customer_email, diagnosis, work_performed, parts_used, total_price, currency, created_at, completed_at, device_id, pricing_id, technician_id, quick_test_data, devices(serial_number, device_type, brand, model), pricing(service_name, price)")
